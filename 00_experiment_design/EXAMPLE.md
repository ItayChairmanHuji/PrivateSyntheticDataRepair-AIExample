...
In `00_experiment_design/config/`, you create a master template:
...
**Command:**
```powershell
python 00_experiment_design/src/generate_blueprint.py --template alpha_sweep_template.yaml
```

## 3. What I will output (Output)
The script will populate `00_experiment_design/output/` with a self-contained "Blueprint" folder.
