...
from s01_loading.src.components.dcs_encoder import DCsEncoder
from s01_loading.src.components.dcs_loader import DCsLoader
from s01_loading.src.components.metadata_loader import MetadataLoader
from s01_loading.src.loader import Loader
...
class FileLoader(Loader):
    ...
    def load(self) -> Dataset:
        ...
        return Dataset(
            name=self.name, data=encoded_data, dcs=encoded_dcs, target=target, mappings=mappings
        )
