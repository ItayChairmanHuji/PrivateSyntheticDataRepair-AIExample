...
from p_processes.p02b_sampling.src.workers.sampling_worker import SamplingWorker
from p_processes.p02b_sampling.src.engine.sampling_engine import SamplingEngine
from p_processes.p02b_sampling.src.orchestration.sampling_orchestrator import SamplingOrchestrator
...
def test_sampling_orchestrator(mock_rpm_env):
    ...
    worker = SamplingWorker(sampler=DummySampler())
