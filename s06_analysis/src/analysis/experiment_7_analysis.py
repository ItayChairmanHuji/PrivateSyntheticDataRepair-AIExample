# %%
# [MARKDOWN]
# # Experiment 7 Analysis: Dynamic Alpha VC Repair
# Comparison of Vanilla, Classic, and Weighted VC (with Dynamic Alpha) as a function of Epsilon.
...
# Load flattened data
DATA_PATH = Path("../input/experiment_7_repair_comparison_flat.csv")
...
# [MARKDOWN]
# ## 2b. Marginals Loss
# The marginal distance component of the loss function.
...
for dataset in datasets:
    ...
    plt.ylabel("Marginals Loss (Repaired)")
    plt.xlabel("Epsilon")
    plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
    plt.tight_layout()
    plt.show()
...
# Comparing the efficiency of the three algorithms.
