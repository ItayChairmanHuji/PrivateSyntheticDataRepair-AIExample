...
def aggregate_experiment_4(blueprint_path, results_dir, output_path):
    ...
    for exp_dir in exp_dirs:
        ...
        try:
            ...
            row = {
                ...
                "loss_total_synthetic": res.get("loss_function", {}).get("synthetic", {}).get("total"),
                "loss_total_repaired": res.get("loss_function", {}).get("repaired", {}).get("total"),
                ...
                # Runtime (Repaired runtime if available, else 0)
                "runtime": res.get("runtimes", {}).get("repair", 0)
            }
...
if __name__ == "__main__":
    aggregate_experiment_4(
        blueprint_path="mission_control/blueprints/experiment_4_repair_comparison/blueprint.json",
        results_dir="outputs/experiment_4_repair_comparison",
        output_path="s06_analysis/output/experiment_4_summary.csv"
    )
