...
3. `RepairingEngine` and `RepairingWorker` are injected into `RepairingWorker` along with configuration parameters (`dataset_name`, `synthesizer_name`, `repairer_name`, `epsilon`, `seed`, `size`, `noise_level`, `alpha`).
