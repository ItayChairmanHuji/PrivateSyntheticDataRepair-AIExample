...
## Usage (CLI)
```bash
python -m p_processes.p02a_training.main dataset_name=adult100 synthesizer_name=mst epsilon=0.1 seed=42
```

## Usage (Library)
```python
from p_processes.p02a_training import train_model
